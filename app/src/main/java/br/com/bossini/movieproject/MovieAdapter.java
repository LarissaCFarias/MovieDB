...
public class MovieAdapter extends BaseAdapter {
    ...
    ArrayList<NetworkUtils.Movie> list;

    public MovieAdapter(Context context, ArrayList<NetworkUtils.Movie> movieList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ImageView imageView;
        NetworkUtils.Movie movies = (NetworkUtils.Movie) getItem(position);
